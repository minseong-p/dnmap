...
class SHINEConfig:
    ...
    def load(self, config_file):
        ...
        self._load(config_args)

    def _load(self, config_args):
        # common
...
class DiscreteConfig(SHINEConfig):
    def __init__(self):
    ...
    def _load(self, config_args):
        super()._load(config_args)

        self.bitwidth = config_args["discrete"]["bitwidth"]

class DNMapConfig(DiscreteConfig):
    def __init__(self):

        super().__init__()
        self.use_continuous: bool = False # low_resolution_continuous_embedding
        self.continuous_embedding_level: int = 0 # tree level
        self.efficient_implementation: bool = False

    def _load(self, config_args):
        super()._load(config_args)

        self.use_continuous = config_args["dnmap"]["use_continuous"]
        self.continuous_embedding_level = config_args["dnmap"]["continuous_embedding_level"]
        self.efficient_implementation = config_args["dnmap"]["efficient_implementation"]