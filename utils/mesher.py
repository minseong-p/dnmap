...
from model.feature_octree_base import FeatureOctreeBase as FeatureOctree
# from model.dnmap_discrete_feature_octree import DecompositionBasedEmbeddingSpace as FeatureOctree
